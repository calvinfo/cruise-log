...
/**
 * Commit all the entries up until index, removes them from the log
 */

Log.prototype.commit = function (index, callback) {
...
Log.prototype.append = function (index, term, value) {
  var entry = {
    index: index,
    term: term,
    value: value
