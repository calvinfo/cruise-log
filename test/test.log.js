...
describe('Log', function () {
  ...
  describe('#append()', function () {
    ...
    it('should not append entries with old terms', function () {
      var log = new Log();
      assert(log.append({ term: 2, index: 1 }));
      assert(!log.append({ term: 1, index: 2}));
    });

    it('should not append entries with old indicies', function () {
      var log = new Log();
      assert(log.append({ term: 2, index: 2 }));
      assert(!log.append({ term: 2, index: 1}));
    });
  });
